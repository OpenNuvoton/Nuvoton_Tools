...
**Note**: Nu-Link3-Pro bridge does not include dedicated I2C and SPI monitor modes. Nu-Link3-Pro uses [PulseView](../../../Documents/Nu-Link3-Pro_User_Manual/docs/06_additional_features/02_pulseview.md) for I2C and SPI signal monitoring and protocol analyzing instead.
