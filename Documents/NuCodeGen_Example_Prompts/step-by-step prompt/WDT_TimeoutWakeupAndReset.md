...
- Pin Connect:
  - PA.0 are connected to Nulink 3 pro PSIO_CH0 for waveform observation using [PulseView](https://github.com/OpenNuvoton/Nuvoton_Tools/blob/master/Documents/Nu-Link3-Pro_User_Manual/ch6_1_pulseview.md).
