...
| **[Nu-Link3 PulseView](https://github.com/OpenNuvoton/pulseview)** | Logic Analyzer GUI based on open-source sigrok/PulseView project. | Windows | GPL v3 | [Setup Guide](./Documents/Nu-Link2_Nu-Link3_User_Manual/docs/06_additional_features/02_pulseview.md) |
| **[Nu-Link3 sigrok-cli](https://github.com/OpenNuvoton/sigrok-cli/releases)** | Logic Analyzer CLI based on open-source sigrok/sigrok-cli project. | Windows | GPL v3 | [Guide](./Documents/Nu-Link2_Nu-Link3_User_Manual/docs/06_additional_features/03_sigrok_cli.md) |
